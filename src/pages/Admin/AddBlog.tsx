...
const quillRef = useRef<any | null>(null);
  ...
  return (
    <form
      ...
      className="flex bg-blue-50/50 text-gray-600  w-full overflow-scroll"
    >
      <div className="bg-white w-full h-fit  max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
